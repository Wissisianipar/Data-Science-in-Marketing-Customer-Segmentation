...
Apa alasan paling kuat kenapa akhirnya harus menggunakan algoritma komputer untuk membantu proses customer segmentation?
  
Agar dapat membagi-bagi segmen customer dengan gampang
...
pelanggan <- read.csv("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/customer_segments.txt", sep="\t")
...
D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/customer_segments.txt", sep="\t": lokasi dataset yang terdapat di DQLab dan sudah disimpan di komputer.
...
praktek-praktek yang menjadi dasar dari semua hal sebelum penggunaan analisa data, yaitu ##tahap persiapan data atau data preparation.
...
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/download.png")
...
{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/matrix.png")
...
`
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/analisa.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/ss.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/ss2.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/sembilan_componen.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/k_means.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/penjelasan.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/output.png")
```
#
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/segmen.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
knitr::include_graphics("D:/DATA SCIENCE/DATA SCIENTIST - KOMINFO/5. Data Science in Marketing Customer Segmentation/segmentasi_customer/profesi.png")
```
